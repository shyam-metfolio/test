    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          ...
          <span className='text-muted mt-1 fw-semibold fs-7'>20 Goals Created last 1 month</span>
        </h3>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <span className='text-muted fw-semibold text-muted d-block fs-7'>Daily</span>
                </td>
              ...
              <tr>
                ...
                <td>
                  ...
                  <span className='text-muted fw-semibold text-muted d-block fs-7'>17th of every Month</span>
                </td>
                <td className='text-end'>
                <a href='#' className='btn btn-sm btn-light-primary'>
                View Order
                ...
                <td>
                  ...
                  <span className='text-muted fw-semibold text-muted d-block fs-7'>Weekly on Sunday</span>
                </td>
                <td className='text-end'>
                <a href='#' className='btn btn-sm btn-light-primary'>
                View Order
